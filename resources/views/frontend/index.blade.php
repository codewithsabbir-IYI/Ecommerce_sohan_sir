...
@section('content')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px" data-aos="fade-up"
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="single-product.html" class="image">
                                                    <img src="{{asset('frontend/images')}}/product-image/5.jpg" alt="Product" />
                                                </a>
                                                <span class="badges">
                                    ...
                                    <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px" data-aos="fade-up"
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="single-product.html" class="image">
                                                    <img src="{{asset('frontend/images')}}/product-image/7.jpg" alt="Product" />
                                                </a>
                                                <span class="badges">
                                    ...
                                    <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-md-30px mb-lm-30px"
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="single-product.html" class="image">
                                                    <img src="{{asset('frontend/images')}}/product-image/2.jpg" alt="Product" />
                                                </a>
                                                <span class="badges">
                                    ...
                                    <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6  mb-md-30px mb-lm-30px"
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="single-product.html" class="image">
                                                    <img src="{{asset('frontend/images')}}/product-image/4.jpg" alt="Product" />
                                                </a>
                                                <span class="badges">
                                                </span>
                                                <div class="actions">
                                    ...
                                    <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-es-30px" data-aos="fade-up"
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="single-product.html" class="image">
                                                    <img src="{{asset('frontend/images')}}/product-image/6.jpg" alt="Product" />
                                                </a>
                                                <span class="badges">
                                                </span>
                                                <div class="actions">
        ...
        <div class="banner-area pt-100px pb-100px plr-15px">
            <div class="row m-0">
                ...
                <div class="col-12 col-lg-4 center-col mb-md-30px mb-lm-30px mt-2">
                    <div class="single-banner-2">
                        <img src="{{asset('dashboard/uploads/category_photos')}}/{{$category->category_photo}}" alt="Image not found">
                        <div class="item-disc">
                    ...
                    <div class="col-lg-4 mb-md-30px mb-lm-30px">
                        <div class="single-blog">
                            <div class="blog-image">
                                <a href="blog-single-left-sidebar.html"><img src="{{asset('frontend/images')}}/blog-image/1.jpg"
